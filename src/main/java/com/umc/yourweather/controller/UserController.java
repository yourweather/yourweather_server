...
public class UserController {
    ...
    @Operation(summary = "비밀번호 찾기", description = "비밀번호 찾기 API 입니다. 이메일 인증을 통해 비밀번호를 재설정할 수 있습니다.")
    public ResponseDto<UserResponseDto> findPassword(
        @RequestBody @Valid EmailRequestDto emailRequestDto) {

        return ResponseDto.success("비밀번호 변경 아이디 조회 성공",
